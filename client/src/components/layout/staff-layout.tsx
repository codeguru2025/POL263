    ...
    <div className="min-h-screen flex bg-background">
      ...
      <aside className="w-64 border-r bg-card flex flex-col shadow-[1px_0_10px_rgba(0,0,0,0.02)] z-10 relative">
        <div className="h-16 flex items-center px-6 border-b shrink-0">
          <img src="/assets/logo.png" alt="Logo" className="h-8 w-8 rounded mr-3 shadow-sm border border-border/50" />
        ...
        <div className="p-4 border-t bg-muted/10 shrink-0">
          <div className="flex items-center gap-3 px-2 py-2 mb-2 bg-card rounded-lg border shadow-sm">
            ...
            <div className="flex-1 overflow-hidden">
              ...
              <p className="text-[10px] uppercase tracking-wider font-semibold text-primary mt-0.5">Superuser</p>
            </div>
          </div>
          <Link href="/">
            <Button variant="ghost" className="w-full justify-start text-muted-foreground hover:text-destructive hover:bg-destructive/10" data-testid="btn-logout">
      ...
      <main className="flex-1 flex flex-col h-screen overflow-hidden bg-background">
        ...
        <header className="h-16 border-b bg-card/50 backdrop-blur-sm flex items-center px-8 justify-between shrink-0 z-10 sticky top-0">
          ...
          <div className="flex items-center gap-2">
            <div className="px-3 py-1 rounded-full bg-primary/10 text-primary text-xs font-semibold tracking-wide border border-primary/20">
