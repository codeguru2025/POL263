      ...
      <PageShell>
        ...
        <CardSection title="" flush>
          <FilterBar className="border-b border-border/60 bg-muted/10 px-4 py-3 sm:px-6">
            ...
            ) : !["fleet", "expenditures", "cashups", "payroll", "commissions", "commission-payments", "platform", "income-statement", "cash-flow", "ledger", "balance-sheet", "funerals", "payments", "actuarial", "data-integrity", "collection-efficiency", "persistency", "lapse-analysis", "member-movement", "claims-aging", "claims-analytics"].includes(activeReport) ? (
              <Select value={statusFilter || "__all__"} onValueChange={(v) => setStatusFilter(v === "__all__" ? "" : v)}>
                <SelectTrigger className="w-44 h-9"><SelectValue placeholder="All statuses" /></SelectTrigger>
                <SelectContent>
                  <SelectItem value="__all__">All statuses</SelectItem>
