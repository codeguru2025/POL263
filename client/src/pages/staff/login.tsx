    ...
    <div className="min-h-screen bg-muted/30 flex items-center justify-center p-4">
      <Card className="w-full max-w-md border-border/50 shadow-lg">
        ...
        <CardContent className="space-y-4">
          ...
          <Link href="/staff">
            <Button className="w-full h-12 text-base font-medium bg-white text-black border border-gray-200 hover:bg-gray-50 hover:text-black shadow-sm flex items-center gap-3" data-testid="btn-google-login">
