    ...
    <ClientLayout clientName="">
      <PageShell className="max-w-2xl mx-auto">
        ...
        <PageHeader
          ...
          description="View status and lodge a new claim when you need to."
          actions={(
            <Button size="sm" className="gap-2 touch-target sm:min-h-9 shrink-0 w-full sm:w-auto" onClick={() => setShowForm(true)}>
