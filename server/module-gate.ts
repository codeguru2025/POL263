...
export const ALL_KNOWN_MODULES = ["claims", "funeral_ops", "fleet", "payroll", "whatsapp_notifications", "mobile_payments", "email_notifications", "email_inbound", "sms_notifications", "legacy_records"] as const;
